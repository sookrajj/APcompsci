...
public class LoginClient {
    public static void main(String[] args) throws Exception{
        ...
        while (!success && cnt < 5) {
            ...
            username = CeaserCipher.encrypt(username, ENC_OFFSET);
            password = CeaserCipher.encrypt(password, ENC_OFFSET);
        ...
        System.out.println("Too many guesses you must reset now.");
    }
}
